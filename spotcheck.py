...
Screening0_Language = {
	...
	"ExperimentName Label": ["Test :", "Xét nghiệm :"],
...
class QualitativeAnalysisFrame0(Frame):
	def __init__(self, container):
		...
		self.experiment_name_label = Label(setup_labelframe,
									...
									bg = LABEL_BGD_COLOR,
									fg = LABEL_TXT_COLOR)
		self.experiment_name_label.grid(row=0, column=1, sticky=E, pady=20, padx=10)
		...
		self.user_name_label = Label(setup_labelframe,
								...
								bg = LABEL_BGD_COLOR,
								fg = LABEL_TXT_COLOR)
		self.user_name_label.grid(row=1, column=1, sticky=E, pady=20, padx=10)
		...
		self.template_name_label = Label(setup_labelframe,
								...
								bg = LABEL_BGD_COLOR,
								fg = LABEL_TXT_COLOR)
		self.template_name_label.grid(row=2, column=1, sticky=NE, pady=20, padx=30)
